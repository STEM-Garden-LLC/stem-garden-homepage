import { randomInt, chooseRandomFromArray } from "@/helpers/randomization";
import { InputTypeEnum } from "../connectFourTypes";
...
export function getCombiningQuestion() {
    ...
    let a: number = randomInt(3,20)
    let b: number = randomInt(3,20)
    let c: number = a + b
